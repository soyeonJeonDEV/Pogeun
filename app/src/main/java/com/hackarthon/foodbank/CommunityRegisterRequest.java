...
public class CommunityRegisterRequest  extends StringRequest {
    ...
    // 서버 url 설정 (php 파일 연동)
    final static private String URL = "http://ec2-54-180-46-45.ap-northeast-2.compute.amazonaws.com:3000/community/community_create"; // "http:// 퍼블릭 DNS 주소/Register.php"
