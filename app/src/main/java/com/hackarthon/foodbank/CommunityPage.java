...
// 어떤 값을 선택했는지 토스트를 뿌려줌
                Toast.makeText(CommunityPage.this, adapterView.getItemAtPosition(i)+ " 클릭", Toast.LENGTH_SHORT).show();
...
// ListView 에서 사용할 arrayAdapter를 생성하고, ListView 와 연결
                ArrayAdapter arrayAdapter = new ArrayAdapter<String>(CommunityPage.this, android.R.layout.simple_list_item_1, titleList);
